...
public class LoginManager : MonoBehaviour
{
    ...
    public void LogIn()
    {
        ...
        Assets.Scripts.JSON.login signUpInfo = new Assets.Scripts.JSON.login { user_id = _logInId.text, password = _logInPw.text};
    ...
    public void CreateAccount()
    {
        ...
        Assets.Scripts.JSON.SignUp signUpInfo = new Assets.Scripts.JSON.SignUp { user_id = _signUpId.text, password = _signUpPw.text, name = _signUpName.text, email = _signUpEMail.text };
